...
module Bff
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['BFF_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Bff::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Bff::Action is included
      ...
      # Configure the code that will yield each time Bff::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Bff::Assets::Helpers
      end
    end
