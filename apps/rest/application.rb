...
module Rest
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['REST_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Rest::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Rest::Action is included
      ...
      # Configure the code that will yield each time Rest::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Rest::Assets::Helpers
      end
    end
