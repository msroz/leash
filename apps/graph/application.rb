...
module Graph
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['GRAPH_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Graph::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Graph::Action is included
      ...
      # Configure the code that will yield each time Graph::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Graph::Assets::Helpers
      end
    end
